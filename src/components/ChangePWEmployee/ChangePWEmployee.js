...
const ChangePWEmployee = ({ ...props }) => {
    ...
    if (newPass !== repeatNewPass) {
      ...
      try {
        const res = await axios.get(
          `${TUNNEL}/api/auth/changepw-employee`,
          config
        );
        setNewPass("");
        setRepeatNewPass("");
  ...
  return (
    <div className="forgotpw-container">
      <div className="header-pw">PORTAL DE EMPLEADAS</div>
      ...
      ></input>
      <div
        className="login-btns-employee-change"
        style={{ justifyContent: "center" }}
      >
        <button
          className="change-pw-employee-btn"
...
export default withRouter(ChangePWEmployee);
